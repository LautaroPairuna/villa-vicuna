...
export const routing = defineRouting({
  ...
  //
  // En este proyecto además ya está cubierto por proxy.ts (reescribe toda
  // ruta sin locale explícito a /es antes de que intlMiddleware entre a
  // jugar), así que esto es refuerzo por si ese camino cambia el día de
  // mañana, no un fix de un bug activo.
